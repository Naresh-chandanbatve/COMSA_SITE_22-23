<script lang="ts">
	...
	import DesktopHero from '$lib/assets/desktop-hero.jpg';
...
<div style="--bg-url: url({DesktopHero});" class="hero-bg min-h-[calc(100vh-calc(4rem))] flex flex-col lg:flex-row bg-base-100 snap-end overflow-x-hidden mt-16 scroll-mt-16" id="hero">
	<div id="hero-half" class="flex-grow-[2] flex flex-col">
		<span
			...
			>SYNERGY</span
		><span class="mt-2 mx-auto xl:ml-16 2xl:ml-32 lg:mb-36 text-base-content text-xl xl:text-2xl 2xl:text-4xl">TEXT HERE</span>
	</div>
